...
from YOLOX.yolox.utils import fuse_model, get_model_info, postprocess, vis, filterclasses
# 将YOLOX加入模块搜索目录
import sys
...
# image -n yolox-s -c YOLOX/yolox_weights/yolox_s.pth --path YOLOX/assets/destiny.jpg --conf 0.25 --nms 0.45 --tsize 640 --save_result --device gpu

# video -n yolox-s -c YOLOX/yolox_weights/yolox_s.pth --path YOLOX/videos/MOT20-07.mp4 --conf 0.20 --nms 0.45 --tsize 640 --save_result --device gpu
