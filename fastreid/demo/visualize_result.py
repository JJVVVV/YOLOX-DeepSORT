...
from fastreid.fastreid.evaluation import evaluate_rank
from fastreid.fastreid.config import get_cfg
from fastreid.fastreid.utils.logger import setup_logger
from fastreid.fastreid.data import build_reid_test_loader
from predictor import FeatureExtractionDemo
from fastreid.fastreid.utils.visualizer import Visualizer
...
# --config-file
# fastreid/configs/Market1501/sbs_R50-ibn.yml
# --parallel
# --vis-label
# --dataset-name
#  Market1501
# --output
# fastreid/demo_outputs/sbs_Market_vis
# --opts
# MODEL.WEIGHTS
# fastreid/reid_weights/market_sbs_R50-ibn.pth
